		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SAP FIORI Basic app template",
									"targetURL": "#zsktemplatesapfioribasicapptemplate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zsktemplatesapfioribasicapptemplate-display": {
								"semanticObject": "zsktemplatesapfioribasicapptemplate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zsktemplate.sapfioribasicapptemplate",
									"url": sap.ui.require.toUrl("zsktemplate/sapfioribasicapptemplate")
								}
							}
						}
					}
